...
hidden if the `Moradin-Forms_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Moradin-Forms_DEVELOPER_MODE` to the configure
...
Runs the executable target `Moradin-Forms_exe`.
